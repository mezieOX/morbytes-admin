...
const Login = () => {
  return (
    <div className="min-h-screen pt-[7.4rem]">
      <div className="flex items-center h-full z-[-1] w-screen justify-center absolute">
        <Image
          src={LoginImg}
          alt="title"
          className="w-[62rem] -mt-[7.8rem]"
          objectFit="cover"
        />
      </div>
      <div className="max-w-[35.1rem]  z-20 mx-auto bg-white/40 border-primary border shadow-[0px_17px_17px_0px_#00000040] px-10 pt-11 pb-[5.7rem] rounded-[20px]">
